...
var S = {
  init: function () {
    ...
    // }
    S.UI.simulate('Excalibur|❤️|Cathy|Excalibur ❤️ Cathy');
...
S.Dot = function (x, y) {
  ...
  this.c = new S.Color(240,255,255, this.p.a);
...
S.ShapeBuilder = (function () {
  var gap = 13,
      ...
      fontSize = 500,
      fontFamily = 'Agency FB, Helvetica Neue, Helvetica, Arial, sans-serif';
