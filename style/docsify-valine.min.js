...
window.$docsify = window.$docsify || {}, window.$docsify.plugins = [function (n, i) {
    n.ready((function () {
        ...
        i.id = "vcomments";
        n.getNode("#main");
        i.style = "max-width: 80% !important; margin: 0 auto 20px;", n.appendTo(n.find(".content"), i)
    })), n.doneEach((function () {
        ...
        // console.log(n.path);
        n.appId && n.appKey ? new Valine(n) : console.warn(
            "sorry , appId and appKey must be required .")
    }))
}].concat(window.$docsify.plugins || []);
console.log(window.$docsify.plugins);
